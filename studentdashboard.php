        ...
        <!-- <section id="about"> -->
            <div class="container px-4">
                <div class="row gx-4 justify-content-center">
                    <div class="col-lg-8" style="Background-color: yellow; padding:30px">
...
<?php
        if(isset($_POST['search'])){
                $conn = mysqli_connect('localhost:3308','root','admin','studentresult');
                                ...
                                $result = $conn->query($sql);
                                        ...
                                        while($row = $result->fetch_assoc()) {
                                                ...
                                                if($RollNo == $row["RollNo"] && $Fname == $row["Fname"] && $Lname == $row["Lname"]){
                                                        ...
                                                        <tr class="table-primary">
                                                        <th scope="row"><?php echo "Science:";?></th>
                                                        ...
                                                        <tr class="table-primary">
                                                        <th scope="row"><?php echo "Hindi:";?></th>
